...
var gfyCollection = function () {
    ...
    function setVidLoadedCallback(cb) {
        vidLoadedCallback = cb;
    }
    ...
    function scan() {
        ...
        for (var i = 0; i < elem_coll.length; i++) {
            ...
            var gfyObj = new gfyObject(elem_coll[i], vidLoadedCallback);
    ...
    return {
        ...
        get: get,
        scan: scan,
        setVidLoadedCallback: setVidLoadedCallback
    }
...
var gfyObject = function (gfyElem, vidloadCallback) {
    ...
    var gfyWidth;
    var gfyHeight;
    var vidLoadedCallback = vidloadCallback;
    ...
    function createOverlayCanvas() {
		...
		/* these width and height lines are added to hide the overlay
		   this will give us access to the normal browser controls rather than click-to-pause */
		overlayCanvas.style.width = "0";  
		overlayCanvas.style.height = "0"; 
    ...
    function vidLoaded() {
        ...
        if (!optAutoplay && !isMobile)
            drawPlayOverlay();
        if(vidLoadedCallback) {
            vidLoadedCallback(this);
        }
    }
